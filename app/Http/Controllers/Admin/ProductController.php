...
class ProductController extends Controller
{
    ...
    public function store(Request $req)
    {
        ...
        if ($req->hasFile('image')) {
            ...
            return redirect(route('admin.product.index'))->with("success", "Berhasil menambah data");
        }
    }
    ...
    public function update(Request $req, $id)
    {
        ...
        return redirect(route('admin.product.index'))->with('succes', 'Berhasil mengedit data');
    }
