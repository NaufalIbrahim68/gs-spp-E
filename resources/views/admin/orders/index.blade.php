                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('admin.orders.return', $item->invoice) }}">
                      ...
                      <td>
                        <form action="{{ route("admin.orders.destroy", $item->id) }}" method="post">
                          @csrf
                          @method('DELETE')
                          <a href="{{ route('admin.orders.detail', $item->invoice) }}"  class="btn btn-primary btn-sm ">Detail</a>
                          <button class="btn btn-danger btn-sm">Hapus</button>
                          <a href="{{ route('admin.orders.print', $item->invoice) }}"  class="btn btn-success btn-sm ">Cetak</a>
                        </form>
                      </td>
                    </tr>
                    @empty
